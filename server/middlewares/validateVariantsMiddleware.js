...
//     } else if (!products.description || typeof products.description !== 'string' ) {
//       return res.status(400).json({ message: 'products description should be a string' });
//     } else if (!products.price || typeof products.price !== 'number' || products.price <= 0) {
