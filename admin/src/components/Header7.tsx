          ...
          <div className={`flex transition-height font-semibold ${showSearch ? "block" : "hidden"}`}>
            ...
            <form   className="grow">
              <input
                ...
                className="grow h-8 pl-9 my-auto p-2 pb-2 text-xs w-full sm:text-base overflow-auto focus:outline-[#3977f2] placeholder-[#616161] text-black rounded-md bg-[#f1f1f181]"
              />
            </form>
          </div>
        </div>
